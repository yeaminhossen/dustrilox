...
function dustrilox_customizer_panels_sections( $wp_customize ) {
    ...
    $wp_customize->add_panel( 'dustrilox_customizer', [
        'priority' => 10,
        'title'    => esc_html__( 'Dustrilox Options', 'dustrilox' ),
    ] );
...
function _header_side_fields( $fields ) {
    ...
    $fields[] = [
        ...
        'label'    => esc_html__( 'Map Address', 'dustrilox' ),
        'section'  => 'header_side_setting',
        'default'  => esc_html__( '#', 'dustrilox' ),
        'priority' => 10,
    ];
...
function dustrilox_color_fields( $fields ) {
    ...
    $fields[] = [
        'type'        => 'color',
        'settings'    => 'dustrilox_color_secondary',
    ...
    $fields[] = [
        'type'        => 'color',
        'settings'    => 'dustrilox_color_blue',
        'label'       => __( 'Primary Color', 'dustrilox' ),
        'description' => esc_html__( 'This is a Blue color control.', 'dustrilox' ),
        'section'     => 'color_setting',
        'default'     => '#2FC0AF',
        'priority'    => 10,
    ];
...
function dustrilox_slug_setting( $fields ) {
    ...
    $fields[] = [
        ...
        'default'  => esc_html__( 'portfolio', 'dustrilox' ),
        'priority' => 10,
    ];
