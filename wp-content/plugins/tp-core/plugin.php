...
class TP_Core_Plugin {
    ...
    public function tp_add_custom_icons_tab($tabs = array()){
        ...
        $flaticon_icons = array(
            ...
            'flaticon-industrial-robot-1',
            'flaticon-pushcart',
            'flaticon-industrial-robot-2',
            'flaticon-worker',
            'flaticon-chip',
            'flaticon-container-1',
            'flaticon-lever',
            'flaticon-warehouse',
            'flaticon-tank-truck',
            'flaticon-crusher',
