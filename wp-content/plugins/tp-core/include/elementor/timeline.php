 ...
 * @since 1.0.0
 */
class TP_Timeline extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'tp_services',
            [
                'label' => esc_html__('Timeline List', 'tpcore'),
        ...
        $repeater->add_control(
            'tp_service_year', [
                ...
                'description' => tp_get_allowed_html_desc( 'basic' ),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('2000', 'tpcore'),
                'label_block' => true,
            ]
        );
        $repeater->add_control(
            ...
            <div class="row">
               <div class="col-xl-6 col-lg-6">
                ...
                <?php if ( !empty($settings['tp_desctiption']) ) : ?>
                    <p class="sm-text"><?php echo tp_kses( $settings['tp_desctiption'] ); ?></p>
                <?php endif; ?>
                  </div>
               </div>
               <div class="col-xl-12">
                     ...
                     <div class="col-xl-3 col-lg-6 col-md-6">
                        <div class="history__item mb-30">
                           <div class="sm-item-thumb w-img">
                              ...
                              <div class="sm-item-tag">
                                 <span><?php echo tp_kses($item['tp_service_year' ]); ?></span>
                              </div>
                              <?php endif; ?> 
                           </div>
                           <div class="sm-item-content">
                               <?php if (!empty($item['tp_service_title' ])): ?>
                              <h6><?php echo tp_kses($item['tp_service_title' ]); ?></h6>
                              <?php endif; ?> 
...
$widgets_manager->register( new TP_Timeline() );