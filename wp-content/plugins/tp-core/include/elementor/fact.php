...
class TP_Fact extends Widget_Base {
	...
	protected function render() {
		...
		<?php else: 
            ...
            $this->add_render_attribute('title', 'class', 'section__title tp-el-title');
        ?>	

      <section class="fact__area fact__bg pt-120 pb-120">
         <div class="container">
            <div class="row">
                <?php if ( !empty($tp_image_url) ) : ?> 
               <div class="col-xl-6 col-lg-6">
                  <div class="fact__image w-img">
               ...
               <div class="col-xl-6 col-lg-6">
                  <div class="fact__info">
                    <?php if ( !empty($settings['tp_section_title_show']) ) : ?>
                     <div class="section__wrapper section__wrapper-3 mb-70 tp-el-subtitle">
                        <?php
                            if ( !empty($settings['tp_title' ]) ) :
                                printf( '<%1$s %2$s>%3$s</%1$s>',
                                    tag_escape( $settings['tp_title_tag'] ),
                     ...
                     <div class="fact__content">
                        ...
                        ?>
                        <div class="fact__content-item pb-25">
                           <div class="fact__progress-circular">
                              <input type="text" class="knob" value="0" data-rel="<?php echo tp_kses($item['tp_fact_number' ]); ?>" data-linecap="round" data-width="100" data-height="100" data-bgcolor="#454c52" data-fgcolor="<?php echo esc_attr($settings['fborder_color']); ?>" data-thickness=".14" data-readonly="true" disabled/>
                           </div>
                           <div class="fact__content-item-des">
                            <?php if (!empty($item['tp_fact_title' ])): ?>
                            <h6><?php echo tp_kses($item['tp_fact_title' ]); ?></h6>
                            <?php endif; ?>
                            <?php if (!empty($item['tp_fact_description' ])): ?>
                                <p><?php echo tp_kses($item['tp_fact_description']); ?></p>
                            <?php endif; ?>
                        ...
                        <?php if ( !empty($settings['tp_desctiption']) ) : ?>
                            <div class="fact-border-top">
                                <p class="fc-text mt-25"><?php echo tp_kses( $settings['tp_desctiption'] ); ?></p>
                            </div>
                        <?php endif; ?>
                     </div>
                  </div>
