...
class TP_Hero_Banner extends Widget_Base {
	...
	protected function register_controls() {
        ...
        $this->add_control(
            'tp_hero_cta',
            [
                'label' => esc_html__('CTA Text', 'tpcore'),
                'description' => tp_get_allowed_html_desc( 'intermediate' ),
                'type' => Controls_Manager::TEXTAREA,
                'default' => esc_html__('TP section cta here', 'tpcore'),
                'placeholder' => esc_html__('Type section cta here', 'tpcore'),
            ]
        );        
        ...
        $this->add_control(
            'tp_hero_cookie',
            [
                'label' => esc_html__('Cookie Text', 'tpcore'),
                'description' => tp_get_allowed_html_desc( 'intermediate' ),
                'type' => Controls_Manager::TEXTAREA,
                'default' => esc_html__('TP section cookie here', 'tpcore'),
                'placeholder' => esc_html__('Type section cookie here', 'tpcore'),
            ]
        );
	...
	protected function render() {
		...
		<?php else: 
			...
			$this->add_render_attribute('title_args', 'class', 'banner__content-title');
         ...
         <div class="container">
            <div class="banner__item-3">
                  ...
                  <div class="col-xl-5 col-lg-6">
                     <div class="banner__content">
                       <?php if ( !empty($settings['tp_sub_title']) ) : ?>
                        <span class="banner__content-meta mb-30"><?php echo tp_kses( $settings['tp_sub_title'] ); ?></span>
                        <?php endif; ?>
                        ...
                        <div class="banner__button mt-45">
                            ...
                            <?php if ( !empty($settings['tp_hero_cta']) ) : ?>
                            <div class="banner__cinfo">
                              <?php echo tp_kses( $settings['tp_hero_cta'] ); ?>
                           </div>
                           <?php endif; ?>
                        </div>
                        <?php endif; ?>
               ...
               <div class="banner__d-image">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/img/slider/slider-d.png" alt="">
               </div>
               <div class="banner__shape">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/img/slider/slider-shape-1.png" alt="">
               </div>
               <div class="banner__shape-2">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/img/slider/slider-shape-2.png" alt="">
               </div>
            </div>
            <?php if (!empty($settings['tp_btn_text'])) : ?>
               ...
               <div class="row justify-content-center">
                  <div class="col-xl-7">
                     <div class="appoinment-cta-2__content white-bg">
                        <?php echo tp_kses( $settings['tp_hero_cookie'] ); ?>
                     </div>
                  </div>
               </div>
            </div>
